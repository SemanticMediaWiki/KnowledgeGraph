...
require( path.resolve( __dirname, '../../resources/KnowledgeGraphToolbarFactory.js' ) );
...
require( path.resolve( __dirname, '../../resources/KnowledgeGraphLegend.js' ) );
require( path.resolve( __dirname, '../../resources/KnowledgeGraphNodes.js' ) );
...
global.KnowledgeGraphToolbarFactory = KnowledgeGraphToolbarFactory;
...
global.KnowledgeGraphLegend = KnowledgeGraphLegend;
global.KnowledgeGraphNodes = KnowledgeGraphNodes;
